...
export class Backend implements backendInterface {
    ...
    async addBombola(arg0: string, arg1: string, arg2: number, arg3: number, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBombola(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addTestData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTestData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBombole(): Promise<Array<Bombola>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBombole();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBombola(arg0: string): Promise<Bombola> {
        if (this.processError) {
            try {
                const result = await this.actor.getBombola(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerUtilizzo(arg0: string, arg1: string, arg2: string, arg3: number, arg4: string): Promise<void> {
        if (this.processError) {
            try {
